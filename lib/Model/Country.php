...
class Country implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'country_iso' => 'string',
        'country_name' => 'string',
        'international_dialing_information' => '\Swagger\Client\Model\InternationalDialingInfo[]',
        'region_codes' => 'string[]'
    ];
     ...
     *
     * @return \Swagger\Client\Model\InternationalDialingInfo[]
     */
     ...
     *
     * @param \Swagger\Client\Model\InternationalDialingInfo[] $international_dialing_information Phone number dialing information
     *
     * @return $this
     */
