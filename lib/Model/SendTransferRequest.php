...
class SendTransferRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets send_value
     *
     * @param float $send_value The transfer value to be sent. Specified to two decimal places of accuracy of the major currency unit, e.g. 3.17 USD.
     *
     * @return $this
     */
     ...
     * Sets settings
     *
     * @param \Swagger\Client\Model\Setting[] $settings Product specific name/value pairs to be associated with the transfer request
     *
     * @return $this
     */
     ...
     * Sets bill_ref
     *
     * @param string $bill_ref Bill reference. Required when product has \"LookupBillsRequired\" set to true.
     *
     * @return $this
     */
