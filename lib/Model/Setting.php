...
class Setting implements ModelInterface, ArrayAccess
{
     ...
     * Sets name
     *
     * @param string $name The name of the setting as defined in the SettingDefinition
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value The transfer specific value to associate with the Name
     *
     * @return $this
     */
