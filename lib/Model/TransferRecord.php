...
class TransferRecord implements ModelInterface, ArrayAccess
{
     ...
     * Sets receipt_params
     *
     * @param map[string,string] $receipt_params Name value pairs of data that is in the ReceiptText along with other transactional details returned by the provider
     *
     * @return $this
     */
