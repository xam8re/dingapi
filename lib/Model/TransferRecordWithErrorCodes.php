...
class TransferRecordWithErrorCodes implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'transfer_record' => '\Swagger\Client\Model\TransferRecord',
        'result_code' => 'int',
     ...
     *
     * @return \Swagger\Client\Model\TransferRecord
     */
     ...
     *
     * @param \Swagger\Client\Model\TransferRecord $transfer_record transfer_record
     *
     * @return $this
     */
     ...
     * Sets error_codes
     *
     * @param \Swagger\Client\Model\Error[] $error_codes Any error codes that were returned as part of the SendTransfer or in the case of a Batch `ProcessingMode`  that may have occurred later after the batch was submitted to the Provider.
     *
     * @return $this
     */
